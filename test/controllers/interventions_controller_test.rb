...
class InterventionsControllerTest < ActionController::TestCase
  ...
  test "should create intervention" do
    assert_difference('Intervention.count') do
      post :create, intervention: { intervention: @intervention.intervention, sfname: @intervention.sfname, slname: @intervention.slname }
    end
  ...
  test "should update intervention" do
    patch :update, id: @intervention, intervention: { intervention: @intervention.intervention, sfname: @intervention.sfname, slname: @intervention.slname }
    assert_redirected_to intervention_path(assigns(:intervention))
  end
